...
export default function MockDiscordUi({ children }: PropsWithChildren) {
  return (
    <div className='flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl'>
      {/* server list */}
      <div className='hidden sm:flex flex-col items-center w-[72px] bg-[#202225] py-3'>
      ...
      <div className='hidden md:flex w-60 bg-[#2f3136] flex-col'>
        ...
        <div className='flex-1 overflow-y-auto pt-4'>
          ...
          <div className='px-2 mb-4'>
            ...
            <div className='flex items-center text-sm px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer'>
              <Image
            ...
            <div className='my-1 space-y-px'>
              {Array.from({ length: 4 }).map((_, i) => (
                <div className='flex items-center px-2 py-1.5 rounded text-gray-600 cursor-not-allowed' key={i}>
      ...
      <div className='flex-1 flex flex-col'>
        ...
        <div className='p-4'>
          <div className='flex items-center bg-[#40444b] rounded-lg p-1'>
            ...
            <input
              readOnly
              placeholder='Message at PingPanda'
